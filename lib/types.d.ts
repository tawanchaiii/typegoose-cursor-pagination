...
export interface IPaginateModel<T> extends Model<DocumentType<T>, {}> {
    findPaged(options: IPaginateOptions, query?: Object, projection?: Object, _populate?: (Object | string)[]): Query<IPaginateResult<DocumentType<T>>, DocumentType<T>>;
    findPagedExplain(options: IPaginateOptions, verbose?: VerboseMode, _query?: Object, _projection?: Object): Promise<any>;
    aggregatePaged(options: IPaginateOptions, pipeline: PipelineStage[]): Query<IPaginateResult<DocumentType<T>>, DocumentType<T>>;
}
/**
